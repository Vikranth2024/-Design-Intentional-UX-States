...
// mockApi.js ΓÇö Simulated Orders API
//
// This module simulates a real async API call.
// You can control which state it returns by changing
// the `SIMULATE` constant below.
//
// ≡ƒÄ¢∩╕Å  CHANGE THIS to test different scenarios:
//   'loading'  ΓÇö hangs forever (tests your loading state)
//   'success'  ΓÇö returns order data after a short delay
//   'empty'    ΓÇö returns an empty array (no orders)
//   'error'    ΓÇö rejects with an error (tests error state)
// ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

export const SIMULATE = 'success'  // ΓåÉ Change this to test each state
...
export function fetchOrders() {
  return new Promise((resolve, reject) => {
    if (SIMULATE === 'loading') {
      // Never resolves ΓÇö you can test your loading state indefinitely
      return
    }
