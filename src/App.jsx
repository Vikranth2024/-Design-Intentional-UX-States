...
export default function App() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      {/* Dev toolbar ΓÇö shows which state is being simulated */}
      <div style={{
        ...
        <span style={{ color: 'var(--text-muted)' }}>≡ƒÄ¢∩╕Å  SIMULATE =</span>
        <span style={{
        ...
        <span style={{ color: 'var(--text-muted)' }}>ΓÇö change in src/mockApi.js to test all states</span>
      </div>
